...
export function ChatEmpty({ username }: { username?: string }) {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[60vh] px-6 animate-fade-in">
      <div
      ...
      <div
        className="mt-8 grid grid-cols-2 gap-2 w-full max-w-md text-sm"
        style={{ color: "var(--text-secondary)" }}
      >
        {[
